...
#And only make the ouput of year and happiness index
#The differnce between happy1 is that enables sorted dictionary output for testing
...
def print_sorted_dictionary(D):
    #If the key and value doesn't match
    if type(D) != dict:
        #Make the unmatched output not in the dictionary
        print("Dictionary not found")
        return
    print("Contents of dictionary sorted by key.")
    print("Key", "Value")
    #If it the key and value matched

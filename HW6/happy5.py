...
#The difference between happy4 is that it needs datas from two file(happiness.csv and world_pop_gdp)
#And then combine then all data in gdp with happines index together to make the output
